...
- Pre-existing checks adjusted: EXPECTED_INDEX_COUNTER 358→366 (Task 2 hardening +8 R33-50..57); LATEST_STABLE_TAG v3.0.10 (unchanged — post-tag polish only)
