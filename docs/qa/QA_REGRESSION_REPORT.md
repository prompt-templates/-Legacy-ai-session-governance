...
- Pre-existing checks adjusted: EXPECTED_INDEX_COUNTER 396→400 (Landing page i18n parity +4 R33-88..91); LATEST_STABLE_TAG v3.0.10 (unchanged — post-tag polish only)
