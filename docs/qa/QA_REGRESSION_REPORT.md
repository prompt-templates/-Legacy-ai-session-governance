...
- Pre-existing checks adjusted: EXPECTED_INDEX_COUNTER 356→358 (§0b local-tool alignment +2 R33-48/49); LATEST_STABLE_TAG v3.0.10 (unchanged — post-tag polish only)
