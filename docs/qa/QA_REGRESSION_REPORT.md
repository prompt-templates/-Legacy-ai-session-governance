...
- Pre-existing checks adjusted: EXPECTED_INDEX_COUNTER 374→378 (Task 1 third batch +4 R33-66..69); LATEST_STABLE_TAG v3.0.10 (unchanged — post-tag polish only)
