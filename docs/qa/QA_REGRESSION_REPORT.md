...
- Pre-existing checks adjusted: EXPECTED_INDEX_COUNTER 378→396 (Task 3 external KB governance +18 R33-70..87); LATEST_STABLE_TAG v3.0.10 (unchanged — post-tag polish only)
