...
- Pre-existing checks adjusted: EXPECTED_INDEX_COUNTER 400→402 (INIT install flow dry-run fix +2 R33-92/93); LATEST_STABLE_TAG v3.0.10 (unchanged — post-tag polish only)
