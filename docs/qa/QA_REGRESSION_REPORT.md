...
- Pre-existing checks adjusted: EXPECTED_INDEX_COUNTER 402→407 (Recommended 3 design-layer fixes +5 R33-94..98); LATEST_STABLE_TAG v3.0.10 (unchanged — post-tag polish only)
