...
- R33 series (35 checks after 2026-05-07 round-2 work-pool boundary patch): Onboarding Wizard System — `dev/wizards/` directory (R33-01), `dev/wizards/playbook.md` behavior layer (R33-04), `dev/wizards/README.md` (R33-05), `dev/templates/` namespace + `spec_template.md` + `runbook_template.md` (R33-18..20), AGENTS.md + INIT.md FILE 1 mirror §3.6 Onboarding Wizard System parity (R33-10..11), §5a backup list PROFILE.md+RUNBOOK.md presence (R33-12..13), INIT.md install POST-INSTALL: Profile Selection step (R33-14), §3 PLAN reads PROFILE.md + handles wizard_disabled_spec flag (R33-15..16), INIT.md PROFILE.md template includes wizard_disabled_spec field (R33-17). **v3.0.8 paradigm response additions (R33-21..27): Source-grounding discipline parity (R33-21/22), labeled assumption tags `[from your input]` / `[my inference]` (R33-23/24), INIT.md install Setup Completion + Optional Wizard section (R33-25), Message 1 'Governance framework ready' (R33-26), two-separate-messages discipline (R33-27).** **2026-05-07 round-1 reply-tone hard-rule additions (R33-28..37): §11a rule 5 inline-English-mixing ban parity (R33-28/29), §11a rule 5 ground truth carve-out parity (R33-30/31), §11a rule 2 outcome-first option framing parity (R33-32/33), §5a backup list includes dev/wizards/playbook.md parity (R33-34/35), header startup inventory includes §0a parity (R33-36/37).** **2026-05-07 round-2 work-pool boundary additions (R33-38..41): §1 Work-pool boundary parity AGENTS↔INIT (R33-38/39), §4 Session work-pool boundary parity AGENTS↔INIT (R33-40/41).** Retired in v3.0.7: R33-02/03 (deleted file existence checks), R33-06/07 (i18n parity for deleted schema files), R33-08/09 (no-hardcoding blacklist for deleted schema files).
- Pre-existing checks adjusted: EXPECTED_INDEX_COUNTER 336→350 (reply-tone +10 round 1, work-pool boundary +4 round 2); R29-07 verifies docs/site/index.html stat counter against new total
