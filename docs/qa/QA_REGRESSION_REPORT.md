...
- Pre-existing checks adjusted: EXPECTED_INDEX_COUNTER 350→356 (worktree edge case +6); LATEST_STABLE_TAG v3.0.9→v3.0.10; R29-07 verifies docs/site/index.html stat counter against new total
