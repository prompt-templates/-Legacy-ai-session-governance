...
- Latest run snapshot (UTC): 2026-05-09 (post-v3.0.10 governance extension — §0b local-tool / SDK / skill alignment principle: 第 2 段尾追加 1 段強調 same alignment principle applies to local CLI tools / installed SDKs / package-manager invocations / project-level skills,reuse 既有 §11a rule 4 `UNVERIFIED` 機制,non-breaking;prior 2026-05-08 v3.0.10 GA shipped — worktree edge case governance: §1 worktree fallback for skip-worktree files + §3c canonical execution locus for harness; combined zh-TW LOW residual sweep), 358 automated checks (269 main + 89 legacy auto-chain), 358 pass, 0 fail; includes Phase 1 legacy quarantine + Phase 2 L4 reduction + v3.0-rc.2 §5a backup hotfix + v3.0.1 release-doc sync R29 series (12 checks) + v3.0.2 release-lifecycle 4-phase governance R30 series (6 checks) + v3.0.3 §4 entry-size cap (3 checks: #167-169) + §11a Reply Behavior baseline (6 checks: #170-175) + v3.0.4 closeout-clarity / startup-transparency / lifecycle-svg R31 series (17 checks) + v3.0.5 Tier 2 meta-instruction integration R32 series (34 checks: §0c / §3.5 FPFR / §3b anti-hardcoding / §5 preserve-original / §11a rules 6-10 / §11b Patch-only / §11c Deep-Fix / §13 Tooling Format Rules) + v3.0.7 Onboarding Wizard System R33 series (14 checks after paradigm shift) + v3.0.8 paradigm response R33-21..27 (7 checks: Source-grounding discipline parity AGENTS↔INIT, labeled assumption tags `[from your input]` / `[my inference]` in playbook, INIT.md install Setup Completion + Optional Wizard section, Message 1 'Governance framework ready', two-separate-messages discipline) + 2026-05-07 round-1 reply-tone hard-rule R33-28..37 (10 checks: §11a rule 5 inline-English-mixing ban parity AGENTS↔INIT, ground truth carve-out parity, §11a rule 2 outcome-first option framing parity, §5a backup list dev/wizards/playbook.md parity, header startup inventory §0a parity) + 2026-05-07 round-2 work-pool boundary R33-38..41 (4 checks: §1 Work-pool boundary parity AGENTS↔INIT, §4 Session work-pool boundary parity AGENTS↔INIT) + 2026-05-08 worktree edge case R33-42..47 (6 checks: §1 Worktree fallback parity AGENTS↔INIT, §3c Canonical execution locus parity AGENTS↔INIT, skip-worktree convention reference parity AGENTS↔INIT) + **2026-05-09 §0b local-tool alignment R33-48/49 (2 checks: §0b local-tool / SDK / skill alignment principle parity AGENTS↔INIT)**
- **Run automated checks:** `bash docs/qa/run_checks.sh` (from main repo path — see AGENTS.md §3c canonical execution locus rule)
